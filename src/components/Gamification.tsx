...
const LEVELS = [
  { level: 1, name: 'Новичок', minPoints: 0, emoji: '🌱', reward: 'Начните задавать вопросы!' },
  { level: 2, name: 'Активный', minPoints: 50, emoji: '⚡', reward: '+5 бонусных баллов' },
  { level: 3, name: 'Постоянный', minPoints: 150, emoji: '🔥', reward: '+10 бонусных баллов' },
  { level: 4, name: 'Преданный', minPoints: 300, emoji: '💪', reward: '+20 бонусных баллов' },
  { level: 5, name: 'Эксперт', minPoints: 500, emoji: '🎓', reward: '+30 бонусных баллов' },
  { level: 6, name: 'Мастер', minPoints: 800, emoji: '🏆', reward: '+50 бонусных баллов' },
  { level: 7, name: 'Легенда', minPoints: 1200, emoji: '👑', reward: '+100 бонусных баллов' },
];
